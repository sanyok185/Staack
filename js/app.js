(() => {
    ...
    let swiper = new core(".page", {
        freeMode: isTouchDevice(),
        wrapperClass: "page__wrapper",
        slideClass: "screen",
        direction: "vertical",
        modules: [ Navigation, Mousewheel, Pagination, freeMode, Keyboard ],
        observer: true,
        observeParents: true,
        slidesPerView: "auto",
        spaceBetween: 0,
    ...
    function isTouchDevice() {
        if (window.matchMedia("(pointer: coarse)").matches) return true; else return false;
    }
    class ScrollWatcher {
        constructor(props) {
            let defaultConfig = {
